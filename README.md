...
**[打开 0.1.11 短片页](http://127.0.0.1:8642/showcase/0.1.11/)**：防守、反击两段，默认 **4× 速度**，各约 **12.5 秒**，只保留游戏画面，无添加标题、字幕或说明。普通浏览器即可播放，另有同速动图。当前媒体保存在本机，可下载分享。制作方式见 [短片记录](docs/replay-showcase.md)。
