...
**当前玩家稳定版为 0.1.16，主线与压制共同更新。** 本轮补齐原生命令持续执行、矿车遇袭返矿、坦克随实际采矿区域转移屏卫。四图同池主线 **25/32 胜、全部正常结束**，0.1.15 对照 **19/32 胜、1 次上限**；池外另有一场低资金残局上限，保留在 [发布记录](docs/strategy-016.md)。学习研究已扩展到主力持续作战控制，正在 CPU 服务器独立比较两种权限、主线与压力路线的 BC/PPO；当前尚未晋升，见 [本轮记录](docs/operation-control-cycle.md)。
