...
**[打开 0.1.11 短片页](http://127.0.0.1:8642/showcase/0.1.11/)**：防守、反击各约 50 秒，普通浏览器即可播放，无需加载游戏客户端。两份 MP4 为 6.2 / 8.3 MB，配有中文说明和游戏时间，保留电厂与坦克损失；另有 8 秒动图。当前为本地样片，可下载分享，视频未公开上传。机位脚本、生成方式和验证见 [短片记录](docs/replay-showcase.md)。
