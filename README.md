...
**当前本地版本为 0.1.16，主线与压制共同更新。** 本轮补齐原生命令持续执行、矿车遇袭返矿、坦克随实际采矿区域转移屏卫。四图同池主线 **25/32 胜、全部正常结束**，0.1.15 对照 **19/32 胜、1 次上限**；池外另有一场低资金残局上限，保留在 [发布记录](docs/strategy-016.md)。未来学习模块的层次和控制权已记入 [架构讨论](docs/learning-boundary.md)，尚未开始训练。
