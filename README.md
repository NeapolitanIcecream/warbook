...
只想看 AI 对战，可以打开 **[0.1.14 对旧阵地的完整回放](http://127.0.0.1:8642/watch)**：短图，26:15，WarbookRed 获胜。9:45 起敌建筑受损；13:00–13:30 有反向来袭，六名 GI 实际开火，建筑仍掉血且整局损失一座碉堡。回放右下角可输入时刻并「跳到并暂停」，向后跳会从开头重新推进；底部可加速。回放展示真实代价，不是无损防守示范。
